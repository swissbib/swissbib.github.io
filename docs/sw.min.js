(function(){const staticCacheName='static';const version='v1::';const OFFLINE_URL='https://swissbib.github.io/off/';function updateStaticCache(){const urls=['https://swissbib.github.io/','https://swissbib.github.io/manifest.json','/css/index.min.3194927e75096c1cc15abc29992a1fe646736cb8e7c26bc10641a77c48cca41cfb179e59a2dc62e8c996a0969ae2a24a7aee43fa0c0b2331afc891736e4e3197.css','/index.min.js','https://swissbib.github.io/image/background.svg','https://swissbib.github.io/image/background-dark_huacd336bfb7f5597695f9c32d4115a2aa_1561823_1400x787_fill_q75_box_smart1.jpg',OFFLINE_URL,'https://swissbib.github.io/image/logo.min.svg','https://swissbib.github.io/index.json'];return caches.open(version+staticCacheName).then((cache)=>cache.addAll(urls)).catch(e=>{console.log("Error = ",e);console.log(e.stack);});}
